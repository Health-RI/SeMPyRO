...
class HEALTHDCATAPDatasetSeries(DCATDatasetSeries):
...
if __name__ == "__main__":
    ...
    HEALTHDCATAPDatasetSeries.save_schema_to_file(Path(json_models_folder, "HEALTHDCATAPDatasetSeries.json"), "json")
    HEALTHDCATAPDatasetSeries.save_schema_to_file(Path(json_models_folder, "HEALTHDCATAPDatasetSeries.yaml"), "yaml")
